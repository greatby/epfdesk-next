...
const slides = [
  {
    ...
    text: "Our Stockholm campus is more than a place to learn; it’s a community. Here’s why it’s the perfect launchpad for your tech career.",
    image:
      "https://nodcoding.com/wp-content/uploads/2024/07/home-experience-1920x2075.jpg",
  },
  {
    title: "Get Help Finding Accommodation",
    text: "Why not turn your coding journey into an adventure by travelling to Stockholm? We collaborate with Allihoop, a startup that helps with affordable studios around Stockholm.",
    image:
      "https://nodcoding.com/wp-content/uploads/2024/07/home-accommodation-1920x2075.jpg",
  },
  {
    title: "The City of Islands",
    text: "Stockholm stretches across fourteen islands, offering scenery where waterways mix with the vibrant skyline. Each island has its own cultural flavor, from Old Town to Södermalm.",
    image:
            ...
            <div className="flex mt-6">
              {slides.map((_, i) => (
                ...
                >
                  ...
                  {/* Hover blue fill (triggered by parent .group:hover) */}
                  {active !== i && (
