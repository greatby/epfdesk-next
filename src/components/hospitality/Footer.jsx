  ...
  return (
    <footer className=" max-w-7xl mx-auto relative px-8 py-12 md:px-16 md:py-20 overflow-hidden z-[1]">
      ...
      <div className="grid md:grid-cols-2 items-center gap-10 relative">
        {/* Left content */}
        <div>
          <h2 className="text-6xl font-bold text-[#3a2f2c] mb-4">
            Questions?
          </h2>
          <p className="text-3xl font-semibold text-[#3a2f2c] max-w-md">
        ...
        <div className="flex justify-center items-center relative">
          ...
          <a
            ...
            className="text-6xl font-bold text-[#3a2f2c] flex items-center gap-2 relative z-10"
          >
            Get in touch <FiArrowRight className="text-6xl" />
          </a>
        </div>
