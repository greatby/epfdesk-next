...
//           <div className="a-strips hidden md:block"></div>
  ...
  return (
    <>
      ...
      <p className="text-center max-w-3xl mx-auto mb-10 text-gray-700 text-lg">
        The Workforce platform translates complex Acts and filings into four unified
        execution layers — Map, Workflow, Tracking, and Renewals — each purpose-built to
        eliminate manual follow-ups and compliance risk.
      </p>
