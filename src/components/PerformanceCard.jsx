        ...
        <div className="rounded-[12px] flex-1 flex items-center justify-center">
          ...
          <div className="bg-[#cdface] rounded-[20px] p-8">
            <p className="text-[1.2rem] text-[#001f1f] leading-[1.3]">
              ...
              Bangalore enterprises from EPF penalties and compliance chaos with
              zero defaults — and we're ready to do the same for you. From
              Peenya's factories to Whitefield's tech corridors, Electronic
              City, Koramangala, and the CBD, businesses trust us to handle what
              keeps HR teams awake: employee UAN linking that never lags, exit
              marking that meets every deadline, monthly ECRs filed flawlessly,
              inspection notices resolved without penalties, and contractor PF
              obligations that don't become your nightmare. Our difference? We
              don't just tell you what to do, we log into your portal and do it
              for you. Whether you're a startup activating EPFO for the first
              time, a manufacturer drowning in contractor documentation, or an
              IT company fielding employee PF questions, our Bangalore team
              transforms EPF from your constant worry into your competitive
              advantage. Sleep better tonight. Your EPF compliance is now our
              responsibility.
            </p>
          </div>
        </div>
